  ...
  <body>
                            ...
                            display: none;
                              ...
                              .sidenav a:hover,.offcanvas a:focus,.sidenavR a:hover,.offcanvas a:focus{color:#f1f1f1;}
                               .closebtn, .closebtn{font-size:36px;margin-left:50px;position:absolut;right:25px;top:0;}
                            ...
                            <!-- <div class="col-md-4  pb-5"> -->
                                            ...
                                            <div id="mySidenavR" class="   position-absolute sidenavR   sidebar  navbar mt-1 ms-5">
