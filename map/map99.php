      ...
      <div class="container">
         <div class="row">
            <div class="col-sm-12 ">
               ...
               <div id="mySidenavR" class="sidenavR  l-navbar">
                 <div class="container">
                         <div class="navbar-header">
                 <div id="complaint"  >
                  ...
                  <form class="form-inline" action="/action_page.php">
                     <div class="form-group" >
                        ...
                        <div id="sel1"></div>
                        <h4 class="panel-title display-8  lead">Select Classroom Number</h4>

                        <select id="roomN" class="list-group-item text-black-50 "onchange="selectRoomNum(this.value)" >
                        </select>
...
<br> 
                        ...
                        <div class="panel panel-primary table-wrapper-scroll-y my-custom-scrollbar  " id="paneltb">
                          <div class="panel-heading  ">
                            <h4 class="panel-title display-8  lead">Complaint</h4>
