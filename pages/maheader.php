...
<head>
  ...
  <body>
        ...
        <div class="b-example-divider"></div>
          ...
          <li ><a href="maheader.php" class="nav-link px-2 link-secondary">Home</a></li>
                  <!--  <li><a href="Fcheader.php" class="nav-link px-2 link-dark">map</a></li>-->

                  <li ><a href="#" class="nav-link px-2 link-dark">Assign Task</a></li>
                  <li ><a href="#" class="nav-link px-2 link-dark">mange Assign task</a></li>
                  <li ><a href="#" class="nav-link px-2 link-dark">Make complaint</a></li>
                  <li ><a href="#" class="nav-link px-2 link-dark">Statestc</a></li>
                </ul>
