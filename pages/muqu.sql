...
--
-- Host: 127.0.0.1
-- Generation Time: 25 فبراير 2022 الساعة 20:50
...
CREATE TABLE `complaint` (
  ...
  `status` varchar(20) NOT NULL DEFAULT 'Under Processing',
...
(122, '2022-02-23 15:31:14', 'Needs an inspection visit,Projector', 'Under Processing', 'projector', NULL, '105'),
(123, '2022-02-23 15:33:51', 'Needs an inspection visit,Air conditiong', 'Under Processing', 'Air Conditiong', NULL, '104'),
(124, '2022-02-23 15:34:32', 'Needs an inspection visit,PC', 'Under Processing', 'we have a problem for install matlab', NULL, '314'),
(125, '2022-02-23 15:35:34', 'Needs an inspection visit', 'Under Processing', 'this is a problem in image', 'uploads/qrrrr.jpeg', '111');
...
--
ALTER TABLE `complaint`
  MODIFY `complaintId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
