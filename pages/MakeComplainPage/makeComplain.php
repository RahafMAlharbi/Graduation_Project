...
.inv {
  ...
  <body>
	...
	<div class="container-fluid">
     ...
     <button class="btn btn-primary" onclick="myFunction()">Scaan Qr code</button>
              ...
              function onScanSuccess(qrCodeMessage) {
               const sb = document.querySelector('#target');
               const option = new Option('103', '103');
               sb.add(option, undefined);
               document.getElementById('target').value="103";
              }
