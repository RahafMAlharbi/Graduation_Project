...
--
-- Host: 127.0.0.1
-- Generation Time: 18 أبريل 2022 الساعة 01:00
...
(308, '2022-04-17 22:47:56', 'Needs an inspection visit', 'Under Processing', 'ds', NULL, '104', 105);
...
INSERT INTO `manager` (`userId`, `userPassword`, `userName`, `userEmail`, `userAdress`, `phone`, `dateOfBirth`) VALUES
(301, 'Ma1105435564', 'Manager Abdullah', 'abdull@ma.uqu.edu.sa', 'Makkah', '0599878843', '1985-01-11'),
(302, 'Ma1154667543', 'Manager Mohammed', 'mohamm@ma.uqu.edu.sa', 'Jeddah', '0514748367', '1988-01-12');
...
INSERT INTO `worker` (`userId`, `userPassword`, `userName`, `userEmail`, `userAddress`, `phone`, `dateOfBirth`, `salary`, `specialist`) VALUES
(201, 'Wo1105445678', 'Worker Sultan', 'sultt@wo.uqu.edu.sa', 'Makkah', '0599554567', '1980-01-11', 4500, 'Electronic technician'),
(202, 'Wo1187655789', 'Worker Thamer', 'thaa@wo.uqu.edu.sa', 'Jeddah', '0545667832', '1990-02-02', 4500, 'Electronic technician'),
(203, 'Wo1194334567', 'Worker Saad', 'saad@wo.uqu.edu.sa', 'Makkah', '0554678546', '1995-10-11', 5000, 'Mechanic'),
(204, 'Wo1105455632', 'Worker Mazen', 'maz@wo.uqu.edu.sa', 'Makkah', '0505436789', '1990-01-11', 5000, 'Mechanic'),
(205, 'Wo1176550766', 'Worker Yasser', 'yass@wo.uqu.edu.sa', 'Jeddah', '0558764357', '1990-02-11', 4000, 'Facilities technician');
...
--
ALTER TABLE `complaint`
  MODIFY `complaintId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=309;
