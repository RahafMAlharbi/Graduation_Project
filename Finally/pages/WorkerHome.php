      ...
      <header class="p-3 ms-3 mb- border-bottom ">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              <li><a href="ManagerHome.php" class="nav-link px-2 nav ps-5 hedermaargin link-secondary hmarg">Home</a></li>

              <li><a href="Assign Tasks\Assign.php" class="nav-link px-2 ms-4 hedermaargin link-dark hmarg">Assign Tasks</a></li>
              <li><a href="Manage Tasks\Manage.php" class="nav-link px-2 ms-4  hedermaargin link-dark hmarg">Mange Assign Tasks</a></li>

              <li><a href="#" class="nav-link px-2 ms-4 hedermaargin  link-dark hmarg">Statistics</a></li>
            </ul>

            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 heder-search hmarg2">
